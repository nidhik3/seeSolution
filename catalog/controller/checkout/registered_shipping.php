<?php
class ControllerCheckoutRegisteredShipping extends Controller {
	public function index() {
		$this->load->language('checkout/checkout');
			$this->document->setTitle("Shipping Address");
		...
		$this->response->setOutput($this->load->view('checkout/shipping_address_new', $data));
	}
