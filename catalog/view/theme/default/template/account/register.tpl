  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-8 offset-sm-2">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          <legend style="padding: 0px 15px;"><?php echo $text_your_details; ?>
            <hr />
          </legend>
          ...
          <div style="display:none" class="form-group">
            <label class="col-2 control-label" for="input-fax"><?php echo $entry_fax; ?></label>
            <div class="col-10">
            ...
            <?php if ($custom_field['location'] == 'account') { ?>
              <?php if ($custom_field['type'] == 'select') { ?>
                <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                  <label class="col-2 control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                  <div class="col-10">
              ...
              <?php if ($custom_field['type'] == 'radio') { ?>
                <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                  <label class="col-2 control-label"><?php echo $custom_field['name']; ?></label>
                  <div class="col-10">
                    <div>
                      <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                        <div class="radio">
        ...
        <fieldset style="display: none;">
          ...
          <div class="form-group">
            <label class="col-2 control-label"><?php echo $entry_newsletter; ?></label>
            <div class="col-10">
              <?php if ($newsletter) { ?>
